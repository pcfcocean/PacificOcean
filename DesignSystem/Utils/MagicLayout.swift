...
public extension UIView {
    ...
    func pinEdgesToSuperviewEdges(
        ...
        guard let superview: UIView = superview else { fatalError("Нет superview") }
    ...
    func pinExcludingEdgesToSuperviewEdges(
        top: CGFloat? = nil,
        left: CGFloat? = nil,
        bottom: CGFloat? = nil,
        right: CGFloat? = nil
    ...
    func pinEdgesToSuperviewEdges(excluding side: PinSide) {
        switch side {
        case .top:
    ...
    func pinToSuperview(_ sides: PinSide...) {
        guard
            let superview: UIView = superview,
            !sides.isEmpty
        else { fatalError("Нет superview или PinSide") }
    ...
    func pinExcluding(
        ...
        guard
            ...
            self.translatesAutoresizingMaskIntoConstraints == false
        else { fatalError("Попытка использовать pin для view с translatesAutoresizingMaskIntoConstraints = true") }
    ...
    func pin(as view: UIView, using sides: [PinSide]) {
        guard
            view.translatesAutoresizingMaskIntoConstraints == false,
            self.translatesAutoresizingMaskIntoConstraints == false
        else { fatalError("Попытка использовать pin для view с translatesAutoresizingMaskIntoConstraints = true") }
    ...
    func pin(as layoutGuide: UILayoutGuide, using sides: PinSide...) {
        sides.forEach { side in
            switch side {
            case .top:
